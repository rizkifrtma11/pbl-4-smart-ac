...
if (isset($_POST['Register'])) {
    ...
    if (!preg_match($password_regex, $password)) {
        $err .= "<br>Password harus terdiri dari minimal 8 karakter dengan kombinasi huruf besar, huruf kecil, angka, dan simbol";
    }
...
<body>
    ...
    <div class="container-fluid mt-5">
        ...
        <form method="post">
            ...
            <p>Back to <a class="link-dark link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" href="index.php">Login</a></p>
